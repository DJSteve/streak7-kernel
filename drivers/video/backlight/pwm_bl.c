...
static int pwm_backlight_update_status(struct backlight_device *bl)
{
	...
	if (brightness == 0) {
		...
		brightness = 217 - ((brightness * 191) / 225);
...
static struct backlight_device *bl_p;
...
EXPORT_SYMBOL(luna_backlight_callback);
...
EXPORT_SYMBOL(luna_als_update_backlight);
