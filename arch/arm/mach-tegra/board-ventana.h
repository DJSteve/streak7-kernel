...
int ventana_datacards_init(void);

/* external gpios */

/* TPS6586X gpios */
#define TPS6586X_GPIO_BASE	TEGRA_NR_GPIOS
#define AVDD_DSI_CSI_ENB_GPIO	(TPS6586X_GPIO_BASE + 3) 
#define CAMERA_5M_AF_3P3V       (TPS6586X_GPIO_BASE + 1) 
#define DATACARD_3G_3P3V        (TPS6586X_GPIO_BASE + 1)  
