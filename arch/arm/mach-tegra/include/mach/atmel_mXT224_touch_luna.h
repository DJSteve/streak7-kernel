...
struct atmel_avdd_test_t {
	uint      on;
	uint8_t   value;
};

struct atmel_pin_fault_test_t {
	uint      on;
	uint8_t   value;
};

struct atmel_reference_pass_criteria_t {
	uint16_t   max_value;
	uint16_t   min_value;
};

#define __ATMELTOUCHDRVIO 0xAA
#define ATMEL_TOUCH_IOCTL_GET_VERSION _IOR(__ATMELTOUCHDRVIO, 1, struct atmel_id_info_t )
#define ATMEL_TOUCH_IOCTL_SET_SENSITIVITY _IOW(__ATMELTOUCHDRVIO, 2, struct atmel_sensitivity_t )
#define ATMEL_TOUCH_IOCTL_GET_SENSITIVITY _IOR(__ATMELTOUCHDRVIO, 3, struct atmel_sensitivity_t )
#define ATMEL_TOUCH_IOCTL_SET_POWER_MODE _IOW(__ATMELTOUCHDRVIO, 4, struct atmel_power_mode_t )
#define ATMEL_TOUCH_IOCTL_GET_POWER_MODE _IOR(__ATMELTOUCHDRVIO, 5, struct atmel_power_mode_t )
#define ATMEL_TOUCH_IOCTL_SET_LINERITY _IOW(__ATMELTOUCHDRVIO, 6, struct atmel_linerity_t )
#define ATMEL_TOUCH_IOCTL_GET_LINERITY _IOR(__ATMELTOUCHDRVIO, 7, struct atmel_linerity_t )
#define ATMEL_TOUCH_IOCTL_SET_MERGE _IOW(__ATMELTOUCHDRVIO, 8, struct atmel_merge_t )
#define ATMEL_TOUCH_IOCTL_GET_MERGE _IOR(__ATMELTOUCHDRVIO, 9, struct atmel_merge_t )
#define ATMEL_TOUCH_IOCTL_SET_NOISE_SUPPRESSION _IOW(__ATMELTOUCHDRVIO, 10, struct atmel_noise_suppression_t )
#define ATMEL_TOUCH_IOCTL_GET_NOISE_SUPPRESSION _IOR(__ATMELTOUCHDRVIO, 11, struct atmel_noise_suppression_t )
#define ATMEL_TOUCH_IOCTL_SET_POWER_SWITCH _IOW(__ATMELTOUCHDRVIO, 12, struct atmel_power_switch_t )
#define ATMEL_TOUCH_IOCTL_GET_REFERENCES_MODE _IOR(__ATMELTOUCHDRVIO, 13, struct atmel_references_mode_t )
#define ATMEL_TOUCH_IOCTL_GET_DELTAS_MODE _IOR(__ATMELTOUCHDRVIO, 14, struct atmel_deltas_mode_t )
#define ATMEL_TOUCH_IOCTL_SET_GAIN _IOW(__ATMELTOUCHDRVIO, 15, struct atmel_gain_t )
#define ATMEL_TOUCH_IOCTL_GET_GAIN _IOR(__ATMELTOUCHDRVIO, 16, struct atmel_gain_t )
#define ATMEL_TOUCH_IOCTL_GET_CTE_MODE _IOR(__ATMELTOUCHDRVIO, 17, struct atmel_cte_mode_t )
...
#define ATMEL_TOUCH_IOCTL_SET_MULTITOUCHSCREEN _IOW(__ATMELTOUCHDRVIO, 20, struct atmel_multitouchscreen_t)
#define ATMEL_TOUCH_IOCTL_GET_MULTITOUCHSCREEN _IOR(__ATMELTOUCHDRVIO, 21, struct atmel_multitouchscreen_t)
#define ATMEL_TOUCH_IOCTL_SET_SELFTEST_FVS_MODE _IOW(__ATMELTOUCHDRVIO, 22, struct atmel_selftest_t )
#define ATMEL_TOUCH_IOCTL_SET_AVDD_FT_TEST _IOW(__ATMELTOUCHDRVIO, 23, struct atmel_avdd_test_t )
#define ATMEL_TOUCH_IOCTL_SET_PIN_FAULT_FT_TEST _IOW(__ATMELTOUCHDRVIO, 24, struct atmel_pin_fault_test_t )
#define ATMEL_TOUCH_IOCTL_GET_REFERENCE_PASS_CRITERIA _IOR(__ATMELTOUCHDRVIO, 25, struct atmel_reference_pass_criteria_t )
#endif
