...
static const int cpu_millivolts[MAX_DVFS_FREQS] =
	...
	{725, 800, 825, 950, 975, 1025, 1050,  1100, 1175, 1250, 1275, 1375, 1425, 1450, 1450, 1450};
#else
...
static struct dvfs dvfs_init[] = {
	/* Cpu voltages (mV):	   750, 800, 825, 950, 975, 1025, 1050,  1100, 1175, 1250, 1275, 1375, 1425, 1450, 1450, 1450 */
...
#ifdef CONFIG_TEGRA_OC
 	CPU_DVFS("cpu", 1, 0, MHZ, 216, 312, 456, 608, 760,  816,  912,  1000, 1232, 1336, 1424, 1504, 1592, 1600, 1680, 1704),
        CPU_DVFS("cpu", 1, 1, MHZ, 216, 312, 456, 608, 760,  816,  912,  1000, 1232, 1336, 1424, 1504, 1592, 1600, 1680, 1704),
        CPU_DVFS("cpu", 1, 2, MHZ, 816, 912, 1000, 1232, 1336, 1424, 1504, 1592, 1600, 1680, 1704),
        CPU_DVFS("cpu", 1, 3, MHZ, 912, 1000, 1232, 1336, 1424, 1504, 1592, 1600, 1680, 1704),
#else
