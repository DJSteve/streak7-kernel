...
static const int cpu_millivolts[MAX_DVFS_FREQS] =
	...
	{750, 800, 825, 950, 975, 1025, 1050, 1100, 1150, 1175, 1250, 1275, 1275, 1300, 1375, 1375, 1425, 1450, 1450, 1450, 1450, 1450};
#else
...
static struct dvfs dvfs_init[] = {
	/* Cpu voltages (mV):	   750, 800, 825, 950, 975, 1025, 1050, 1100, 1150, 1175, 1250, 1275, 1275, 1300, 1375, 1375, 1425, 1450, 1450, 1450, 1450, 1450 */
...
#ifdef CONFIG_TEGRA_OC
 	CPU_DVFS("cpu", 1, 0, MHZ, 216, 312, 456, 608, 760,  816,  912,  1000, 1200, 1232, 1336, 1400, 1424, 1472, 1504, 1544, 1592, 1600, 1624, 1680, 1700, 1704),
        CPU_DVFS("cpu", 1, 1, MHZ, 216, 312, 456, 608, 760,  816,  912,  1000, 1200, 1232, 1336, 1400, 1424, 1472, 1504, 1544, 1592, 1600, 1624, 1680, 1700, 1704),
        CPU_DVFS("cpu", 1, 2, MHZ, 816, 912, 1000, 1200, 1232, 1336, 1400, 1424, 1472, 1504, 1544, 1592, 1600, 1624, 1680, 1700, 1704),
        CPU_DVFS("cpu", 1, 3, MHZ, 912, 1000, 1200, 1232, 1336, 1400, 1424, 1472, 1504, 1544, 1592, 1600, 1624, 1680, 1700, 1704),
#else
	...
	CPU_DVFS("cpu", 2, 3, MHZ,   0,   0,   0,   0, 940, 1000, 1000, 1000, 1130, 1130, 1200),
  	...
  	/* Core voltages (mV):           950,    1000,   1100,   1200,   1225,   1275,   1350 */
