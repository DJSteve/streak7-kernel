...
#define MACHINFO_NAME 16 /* offsetof(struct machine_desc, name)	@ */
#define MACHINFO_PHYSIO 8 /* offsetof(struct machine_desc, phys_io)	@ */
#define MACHINFO_PGOFFIO 12 /* offsetof(struct machine_desc, io_pg_offst)	@ */
